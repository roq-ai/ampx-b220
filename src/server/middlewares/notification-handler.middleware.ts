...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'A new service request has been created.create': {
    roles: ['tenant-roles', 'tenant-owner-roles'],
    key: 'service_request',
    tenantPath: [],
    userPath: [],
  },
  'A service request has been updated.update': {
    roles: ['tenant-roles'],
    key: 'service_update',
    tenantPath: [],
    userPath: [],
  },
  'A service request has been completed.update': {
    roles: ['tenant-owner-roles'],
